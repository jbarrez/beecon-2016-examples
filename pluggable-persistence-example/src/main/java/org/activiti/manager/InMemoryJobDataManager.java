...
public class InMemoryJobDataManager extends AbstractInMemoryDataManager<JobEntity> implements JobDataManager {
	...
	public List<Job> findJobsByTypeAndProcessDefinitionKeyNoTenantId(String jobHandlerType,
			String processDefinitionKey) {

		ProcessDefinitionEntity processDefinitionEntity = getProcessDefinitionEntityManager()
	...
	public List<Job> findJobsByTypeAndProcessDefinitionKeyAndTenantId(String jobHandlerType,
